...
- **多元函数的泰勒公式**
    - **拉格朗日余项**
        - 设[多元函数](/notes/docs/mathematics/calculus/multivariate-function) $f(x,y)$ 在 $(x_0,y_0)$ 的某邻域有 $n+1$ 阶连续[偏导数](/notes/docs/mathematics/calculus/partial-derivative)。
...
- **应用**
    ...
    - **求极限**
        - 求[极限](/notes/docs/mathematics/calculus/limit)时如果无法运用常见等价无穷小，则可以将计算式中的复杂函数展开。
